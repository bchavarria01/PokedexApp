...
internal enum R {
  internal enum Base {
    ...
    internal static let charizard = ImageAsset(name: "charizard")
    internal static let icBackArrow = ImageAsset(name: "ic_back_arrow")
    internal static let icPokeball = ImageAsset(name: "ic_pokeball")
    internal static let icPokemonLogo = ImageAsset(name: "ic_pokemon_logo")
    internal static let icRuler = ImageAsset(name: "ic_ruler")
    internal static let icSearch = ImageAsset(name: "ic_search")
    internal static let icWeight = ImageAsset(name: "ic_weight")
  }
